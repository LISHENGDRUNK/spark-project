...
/**
 * @ClassName JDBCTest
 * @Time : 2020/8/12 0012 10:01
 * @Author : lisheng
 * @Description: JDBC增删改查
 **/
...
//        select();
     ...
     * @return void
     * @Author lisheng
     * @Description //TODO 插入测试
     * @Date 10:03 2020/8/12 0012
     * @Param []
     **/
    private static void insert() {
        ...
        try {
            ...
            String sql = "insert into test values(5,2,3,5,'d','b')";
            int in = state.executeUpdate(sql);
            System.out.printf("sql语句影响了" + in + "行");
    ...
    /**
     * @Author lisheng
     * @Description //TODO 测试修改
     * @Date 10:30 2020/8/12 0012
     * @Param []
     * @return void
     **/
    public static void update() {
        ...
        try {
            ...
            String sql = "update test set age=5 where id=5";
    ...
    public static void select() {
        ...
        try {
            ...
            while (rs.next()){
                int id = rs.getInt(1);
                int age = rs.getInt(2);
                System.out.println("查询id为"+id+"的用户年龄为"+age);
            }
    ...
    private static void preparedStatement() {
        ...
        try {
            ...
            String sql = "insert into test(id,age) values(?,?)";
